...
- In classical multivariate analysis, the object is $Y_i\in\mathbb R^d$; in
  FDA, the trajectory $X_i=\{X_i(t):t\in\mathcal T\}$ is the multivariate
  object (time points along the continuum play the role of coordinates).
...
## Coefficients And Truncation {.smaller}
...
- The retained lag $J$ can be selected by an Efromovich threshold/truncation
...
## Parametric Correlation Families {.smaller}

::: nonincremental

The library is deliberately heterogeneous; averaging is over shapes, not just
