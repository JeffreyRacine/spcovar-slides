...
- An empirical CD4 application is presented.
...
## Parametric Correlation Families: $\widehat\rho(s,t)$ {.smaller}
...
- The main tuning choices are selected from the data:
    ...
    - mean and variance functions $(\mu(t),\sigma^2(t))$: projection
      coefficients are estimated in the standard cosine basis, and a smoothed
      Efromovich threshold selects the retained cosine terms;
...
::: {.content-hidden when-profile="short"}
## Covariance Contour Views {#covariance-contour-views}
...
::: {.content-hidden when-profile="short"}
## Nonparametric Covariance Contour View
...
## Semiparametric Covariance Surface
...
::: {.content-hidden when-profile="short"}
## Nonparametric Covariance Surface
...
fit_cd4_np <- npcovar(Lt = Lt, Ly = Ly)
