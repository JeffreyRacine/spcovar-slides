...
- The estimator decomposes the covariance surface into boundary-corrected
  nonparametric marginal scale functions and a structured correlation surface.
...
- The talk also emphasizes the data-driven implementation and a CD4 application
  with static and interactive covariance-surface views.
