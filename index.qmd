...
- An empirical CD4 application is presented with static and interactive covariance-surface views.
...
- The main tuning choices are selected from the data:
    ...
    - model averaging $(\widehat\alpha)$: simplex weights are chosen by the
