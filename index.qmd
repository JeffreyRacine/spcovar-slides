...
- The resulting estimator is computationally attractive, retains flexibility
  ...
  nonparametric sparse FDA covariance estimation.
...
- It is the object behind:
    ...
    - dimension reduction through FPCA/eigenfunctions.
...
- Sparse FDA and FPCA foundations:
    ...
    - PACE estimates mean/covariance surfaces and recovers scores by conditional
      expectation [@Yao2005Sparse].
...
- Direct covariance-surface estimation:
    ...
    - FACE uses fast penalized-spline covariance smoothing [@Xiao2018SparseFACE].
