...
parametric and fully nonparametric sparse FDA covariance estimation. The talk
also emphasizes the data-driven implementation and a CD4 application with
static and interactive covariance-surface views.
...
3. Nonparametric mean and variance estimation with boundary correction
4. Correlation families, model averaging, and implementation details
5. Finite-sample evidence
6. CD4 application and live covariance-surface demo
